...
async function collectTabStats() {
  ...
  console.log('=== TabTherapist: Tab İstatistikleri ===');
  console.log(`Toplam sekme sayısı: ${totalTabs}`);
  console.log(`Pencere sayısı: ${totalWindows}`);
  console.log('Pencere başına sekme:', windowMap);
  console.log('Domain bazlı dağılım:', domainMap);
  console.log(`Duplicate sekme sayısı: ${duplicateCount}`);
  if (duplicateCount > 0) {
    console.log('Duplicate URL\'ler:', duplicates);
  }
  console.log('========================================');
  ...
  console.log(`Tab Hoarding Score: ${score} - [${personality}]`);
  console.log('Skor Dağılımı:', breakdown);
...
console.log('TabTherapist Service Worker çalışıyor');
